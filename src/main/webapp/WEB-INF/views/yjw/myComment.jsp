            ...
            <div class="tab-pane fade show active" id="free" role="tabpanel">
                <div class="scroll-area">
                    ...
                    <c:if test="${empty freeComments}">
                        <div class="text-center text-muted py-5">아직 내가 작성한 자유 게시판 댓글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
            <!-- 실종 게시판 -->
            <div class="tab-pane fade" id="miss" role="tabpanel">
                <div class="scroll-area">
                    ...
                    <c:if test="${empty missComments}">
                        <div class="text-center text-muted py-5">아직 내가 작성한 실종 게시판 댓글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
            <!-- 위탁 게시판 -->
            <div class="tab-pane fade" id="entrust" role="tabpanel">
                <div class="scroll-area">
                    ...
                    <c:if test="${empty entrustComments}">
                        <div class="text-center text-muted py-5">아직 내가 작성한 위탁 게시판 댓글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
            <!-- 신고 게시판 -->
            <div class="tab-pane fade" id="flag" role="tabpanel">
                <div class="scroll-area">
                    ...
                    <c:if test="${empty flagComments}">
                        <div class="text-center text-muted py-5">아직 내가 작성한 신고 게시판 댓글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
        </div>
