...
<header>
	...
	<nav class="top-nav">
		...
		<ul id="primaryNav" class="nav-tabs">
			...
			<li class="main-menu active"><a href="/free">커뮤니티</a>
				<ul class="sub-menu">
		...
		<div class="icons">
			<div class="icon-link" style="margin-right: 4px;">
				<button id="alertBtn" type="button" class="icon-btn" data-bs-html="true" data-bs-container="body" title="알림" aria-label="알림">
			...
			<a href="/chat" class="icon-btn" title="쪽지" style="text-decoration: none; position: relative;"> <i class="bi bi-envelope"></i> <c:if test="${totalUnreadCount > 0}">
					<span id="total-unread-count-sm" class="badge unread-count-badge" style="position: absolute; top: 0; right: 0; transform: translate(50%, -50%);"> ${totalUnreadCount} </span>
				</c:if>
			</a>
...
@media ( max-width : 992px) {
	...
	.top-nav .main-menu:hover .sub-menu {
		display: none;
	}
	...
	.top-nav .main-menu.open .sub-menu {
		display: block;
	}
	.nav-toggle {
		display: inline-flex;
