...
<body>
    ...
    <form action="/edit" method="post">
        <div>
            ...
            <input type="password" id="edit-password" name="password" placeholder="변경 시에만 입력해주세요. 비밀번호는 영어와 숫자가 하나 이상 포함된 8~16자리의 영어, 숫자, 특수문자만 가능합니다." />
            <p id="password-message" class="message"></p>
        </div>
        <div>
            <label for="edit-nickname">닉네임:</label>
            <input type="text" id="edit-nickname" name="nickname" value="${member.nickname}" placeholder="닉네임은 2~12 자리의 한글, 영어, 숫자만 가능합니다." required/>
    ...
    <script type="text/javascript">
        ...
        function initializeRegion() {
            ...
            if (memberCity) {
                ...
                if (memberDistrict) {
                    districtSelect.value = memberDistrict;
                }
            }
        }
        ...
        $('form').on('submit', function(e) {
            ...
            if ((isPasswordChanged && !isPasswordValid) || (isNicknameChanged && !isNicknameValid)) {
