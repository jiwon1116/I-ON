	...
	<div class="container">
		...
		<ul class="chat-room-list" id="chat-room-list">
			<c:forEach var="room" items="${chatRooms}">
				<li class="chat-room-item" data-room-id="${room.id}"><a href="/chat/room/${room.id}" class="chat-room-link">
						<div class="chat-room-info">
							<p>
								<strong>상대방: ${room.partnerNickname}</strong>
							</p>
       ...
       async function handleNewMessage(message) {
               ...
               if (!chatRoomDiv) {
                   ...
                   try {
                       ...
                       lastMessageP.textContent = '최근 메시지: ' + messageContent;
