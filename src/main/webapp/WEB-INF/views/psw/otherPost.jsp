            ...
            <div class="tab-pane fade show active" id="free" role="tabpanel">
                <div class="scroll-area">
                    ...
                    <c:if test="${empty freePosts}">
                        <div class="text-center text-muted py-5">아직 ${nickname}님이 작성한 자유 게시글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
            <!-- 실종 게시판 -->
            <div class="tab-pane fade" id="miss" role="tabpanel">
                <div class="scroll-area">
                    ...
                    <c:if test="${empty missPosts}">
                        <div class="text-center text-muted py-5">아직 ${nickname}님이 작성한 실종 게시글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
            <!-- 위탁 게시판 -->
            <div class="tab-pane fade" id="entrust" role="tabpanel">
                <div class="scroll-area">
                    ...
                    <c:if test="${empty entrustPosts}">
                        <div class="text-center text-muted py-5">아직 ${nickname}님이 작성한 위탁 게시글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
            <!-- 신고 게시판 -->
            <div class="tab-pane fade" id="flag" role="tabpanel">
                <div class="scroll-area">
                    ...
                    <c:if test="${empty flagPosts}">
                        <div class="text-center text-muted py-5">아직 ${nickname}님이 작성한 신고 게시글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
