...
<div class="container mt-5 mb-5">
    <div class="main-box">
        <ul class="nav nav-pills mb-3 justify-content-center" id="commentTabs" role="tablist">
                    ...
                    <c:forEach var="comment" items="${freeComments}">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="post-meta">
                                    작성일: <c:out value="${comment.created_at}" />
                                </div>
                                <p class="card-text">
                                    <c:out value="${fn:length(comment.content) > 60 ? fn:substring(comment.content, 0, 58) + '...' : comment.content}" />
                                </p>
                            </div>
                        </div>
                    </c:forEach>
                    <c:if test="${empty freeComments}">
                        <div class="text-center text-muted py-5">아직 ${nickname}님이 작성한 자유 게시판 댓글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
            <!-- 실종 게시판 -->
                ...
                <div class="scroll-area">
                    <c:forEach var="comment" items="${missComments}">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <a href="${pageContext.request.contextPath}/miss/${comment.post_id}" style="color:inherit; text-decoration:none;">
                                        [게시글로 이동]
                                    </a>
                                </div>
                                <div class="post-meta">
                    ...
                    <c:if test="${empty missComments}">
                        <div class="text-center text-muted py-5">아직 ${nickname}님이 작성한 실종 게시판 댓글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
            <!-- 위탁 게시판 -->
                ...
                <div class="scroll-area">
                    <c:forEach var="comment" items="${entrustComments}">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <a href="${pageContext.request.contextPath}/entrust/${comment.post_id}" style="color:inherit; text-decoration:none;">
                                        [게시글로 이동]
                                    </a>
                                </div>
                                <div class="post-meta">
                    ...
                    <c:if test="${empty entrustComments}">
                        <div class="text-center text-muted py-5">아직 ${nickname}님이 작성한 위탁 게시판 댓글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
            <!-- 신고 게시판 -->
                ...
                <div class="scroll-area">
                    <c:forEach var="comment" items="${flagComments}">
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">
                                    <a href="${pageContext.request.contextPath}/flag/${comment.post_id}" style="color:inherit; text-decoration:none;">
                                        [게시글로 이동]
                                    </a>
                                </div>
                                <div class="post-meta">
                    ...
                    <c:if test="${empty flagComments}">
                        <div class="text-center text-muted py-5">아직 ${nickname}님이 작성한 신고 게시판 댓글이 없습니다.</div>
                    </c:if>
                </div>
            </div>
        </div>
